...
#define FASTSEARCH(S,C,N) (void*) strchr ((const char*)(S), (C))
                        ...
                        size_t *period)
{
  ...
  while (j + k < needle_len)
    {
      ...
      // cout<<"needl[j+k] = "<<needle[j+k]<<" needle[max_suffix + k] = "<<needle[max_suffix+k]<<endl;
      // cout <<" j ="<<j<<" k = "<<k<<" max_suffix = "<<max_suffix<<" pa = "<<a<<" pb = "<<b<<endl;
      if (a < b)
        {
          ...
          k = 1;
          p = j - max_suffix;
          // cout<<"pa < pb j = "<<j<<" k = "<<k<<" p = "<<p<<" max_suffix = "<<max_suffix<<endl;
        }
      else if (a == b)
        {
  ...
  *period = p;
  cout<<"k = "<<k<<" p = "<<p<<" max_suffix = "<<max_suffix<<endl;
  ...
  while (j + k < needle_len)
    {
      ...
      // cout<<"needl[j+k] = "<<needle[j+k]<<" needle[max_suffix + k] = "<<needle[max_suffix_rev+k]<<endl;
      // cout <<" j ="<<j<<" k = "<<k<<" max_suffix_rev = "<<max_suffix_rev<<" pa = "<<a<<" pb = "<<b<<endl;
      ...
      if (b < a)
        {
          ...
          k = 1;
          p = j - max_suffix_rev;
          // cout<<"pa > pb j = "<<j<<" k = "<<k<<" p = "<<p<<" max_suffix_rev = "<<max_suffix_rev<<endl;
                      ...
                      const unsigned char *needle, size_t needle_len)
{
  ...
  cout<<"suffix = "<<suffix<<" period = "<<period<<endl; 
  ...
  if (CMP_FUNC (needle, needle + period, suffix) == 0)
    {
      /* Entire needle is periodic; a mismatch can only advance by the
         ...
         of the period.  */
      cout<<"needle is periodic: "<<needle[0]<<" = "<<needle[period]<<" suffix = "<<suffix<<endl;
      size_t memory = 0;
      j = 0;
...
# endif
 ...
 ret0: return NULL; //__attribute__ ((unused))
  return NULL;
}
/* Return the first location of non-empty NEEDLE within HAYSTACK, or
   NULL.  HAYSTACK_LEN is the minimum known length of HAYSTACK.  This
